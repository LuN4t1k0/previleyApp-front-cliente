...
const InstitucionesConsolidado = ({ empresaRut }) => {
    ...
    const fetchData = async () => {
      try {
        ...
        const enriquecido = raw
          ...
          .sort((a, b) => b.deuda - a.deuda); // Orden por mayor deuda

        setData(enriquecido);
      } catch (error) {
        console.error("❌ Error cargando datos por institución:", error);
      }
    };
  ...
  return (
    <Card>
      <Title>🏦 Instituciones: Deuda, Recuperación y Rendimiento</Title>
      <Text className="text-sm text-gray-500 mb-4">
        Visualiza los montos detectados, recuperados y el porcentaje de éxito por institución.
      </Text>
...
export default InstitucionesConsolidado;