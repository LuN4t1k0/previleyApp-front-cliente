...
const {
  ...
  fetchFn: ({ offset, limit }) =>
    fetchPage({
      offset,
      limit,
      extraParams: convertFiltersToQueryParams(filters, ConciliacionConfig.filters),
    }),
  limit: 20,
  ...
  return (
    <div className="w-full px-2 sm:px-6 lg:px-8 pt-4 relative">
      ...
      <GenericTableWithDetail
        ...
        actionHandlers={actionHandlers}
        role={role}
        columnOrder={ConciliacionConfig.columnOrder}
        useInfiniteScroll={ConciliacionConfig.useInfiniteScroll}
        // NUEVOS:
...
const ConcliacionDetalle = () => (
  <FilterProvider config={ConciliacionConfig}>
    <ModalProvider modalsConfig={ConciliacionConfig.modalsConfig}>
      <ConciliacionPageContent />
      <ModalManager />
    </ModalProvider>
  </FilterProvider>
);

export default ConcliacionDetalle;
